...
analysis_title = paste( "Phylogenetic Tree with Highest Likelihood Score\n",
                        "Software used: RAxML v.8.2.9 | MrBayes v.3.2.5\n",
                        ...
                        "Nucleotide substitution model: ML analysis: GTRGAMMAI | Bayesian inference: best-fitting model per partition\n",
                        "Resampling support: 1000 rapid bootstrap runs | 1000 post-burnin MCMC runs\n",
...
###################################################################
cmd = paste("python2.7 /home/michael_science/.local/bin/sumtrees.py","-o", outFile_suppVals,
                          "-t", inFile_plotTree,
                                inFile_suppVals)
system(cmd)
